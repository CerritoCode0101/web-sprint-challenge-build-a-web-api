...
A: Node allows you to execute javascript apps outside of the web browser. express is a framework the works with node to create applications.

1. Understand and explain the use of Middleware.
A: Middleware is used to ececute actions

1. The basic principles of the REST architectural style.
A: REST is about using the principles of the World Wide Web to build applications. REST stands for REpresentational State Transfer.

1. Understand and explain the use of Express Routers.
A: Allows for modularization of the code which is easier to work with and communicate with and separate logic.
